    ...
    return (
        <section className="city_filter">
            <div className="city_filter_container">
                ...
                <p className="city_filter_paragraph paragraph_text">На данной странице вы можете ознакомиться со всеми сообществами Mobile Broadcast, вы также можете добавить новое сообщество или редактировать старое</p>
            </div>
